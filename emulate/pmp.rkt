...
(define (print-pmp m)
		...
		(printf "pmpaddr2 base/range~n")
		(pmp_decode_napot (get-csr m "pmpaddr2"))
		(printf "pmpaddr3 base/range~n")
		(pmp_decode_napot (get-csr m "pmpaddr3"))
		(printf "pmpaddr4 base/range~n")
		(pmp_decode_napot (get-csr m "pmpaddr4"))
		)
